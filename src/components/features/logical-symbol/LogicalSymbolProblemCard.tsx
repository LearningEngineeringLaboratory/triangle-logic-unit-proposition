...
interface LogicalSymbolProblemCardProps {
  problem: Problem
  isCompleted: boolean
}

export function LogicalSymbolProblemCard({ problem, isCompleted }: LogicalSymbolProblemCardProps) {
  ...
  return (
    <div className="relative">
      {isCompleted ? (
        ...
        <Link href={`/logical-symbol/${problem.problem_id}`} className="block">
